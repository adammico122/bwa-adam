            ...
            <div class="col-lg-8" data-aos="zoom-in">
              <transition name="slide-fade" mode="out-in">
                <img
                  ...
                  :key="photos[morePhoto].id"
                  :src="photos[morePhoto].url"
            ...
            <div class="row">
              ...
              <div class="col-lg-2" data-aos="zoom-in">
                ...
                href="{{ route('login') }}"
                  ...
                  >Add to Cart</a> 
                @endauth
                @if ($product->galleries->count() > 6)
                  <button
                  class="btn btn-primary nav-link px-4 text-white btn-block mb-3"
                  @change="morePhoto()"
                  >+{{ $product->galleries->count() - (int) 3 }} Photos</button> 
                </form>
                @endif
              </div>
            </div>
    ...
    <script>
      var gallery = new Vue({
        ...
        data: {
          activePhoto: 0,
          photos: [
            @foreach ($product->galleries->take(6) as $gallery)
              {
              id: {{ $gallery->id }},
